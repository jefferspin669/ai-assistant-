...
export const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/app/ask", label: "Ask Atlas", match: ["/app/chat"] },
    ],
  },
  {
    label: "Work",
    items: [
      { href: "/app/tasks", label: "Tasks", match: ["/app/notes"] },
      { href: "/app/appointments", label: "Calendar" },
      { href: "/app/customers", label: "Customers", match: ["/app/timeline", "/app/reviews", "/app/contacts"] },
      { href: "/app/team", label: "Team", match: ["/app/training"] },
    ],
  },
  {
    label: "Business",
    items: [
      {
        href: "/app/money",
        label: "Money",
        match: ["/app/tax", "/app/finance", "/app/payments", "/app/accountant"],
      },
      {
        href: "/app/sales",
        label: "Sales",
        match: ["/app/quotes", "/app/sales-coach", "/app/marketing", "/app/portal"],
      },
      {
        href: "/app/operations",
        label: "Operations",
