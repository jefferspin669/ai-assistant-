...
// Avoid importing this server-only module from the isomorphic database store.
// Tests and server routes that load the employee service register the reset hook.
(globalThis as typeof globalThis & {
  __atlasResetSeedEmployees?: (organizationId: string) => void;
}).__atlasResetSeedEmployees = resetSeedEmployees;
