...
export default function EventsPage() {
  ...
  return (
    <AppShell
      title="Event AI"
      subtitle="Add celebrations, reunions, and company events — Atlas builds guest lists, vendors, budgets, and timelines."
      action={
            ...
            <>
              ...
              <div className="chat-mock" style={{ marginBottom: "1rem" }}>
                <div className="bubble bubble-user">
                  Plan a {selected.type.toLowerCase()} for {selected.guests} people with a $
                  {selected.budget} budget.
                </div>
                <div className="bubble bubble-ai">
                  Got it — {selected.guests} guests, ${selected.budget} budget. Checklist, budget
                  split, and day-of reminders are ready.
                </div>
              </div>
              <div className="split">
                <div>
