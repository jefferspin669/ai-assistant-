...
export default function PersonalPage() {
  const [messages, setMessages] = useState<Msg[]>([
    { role: "ai", text: "I’m your personal AI — a life manager. Ask about bills, documents, budgets, or plans." },
  ]);
  ...
  return (
    <AppShell title="Personal AI Assistant" subtitle="Think of it like a life manager — with your permission, it remembers what matters.">
      <div className="split">
